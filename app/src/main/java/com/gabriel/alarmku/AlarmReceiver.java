...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message){
        ...
        Toast.makeText(context, "One time alarm is", Toast.LENGTH_SHORT).show();
    }

    public void setRepeatingAlarm(Context context, String type, String time, String message){
        if (isDateInvalid(time, "yyyy-MM-dd") || isDateInvalid(time, "HH:mm")) return;
        ...
        Toast.makeText(context, "Repeating alarm is", Toast.LENGTH_SHORT).show();
